...
const resources = {
  en: {
    translation: {
      ...
      "staff.currentFte": "Current (FTE)",
      "staff.headcount": "headcount",
      ...
      "staff.refreshAnalysis": "Recalculate",
      "staff.debugInfo": "Debug Info",
      "staff.roleHistogram": "Role Histogram",
      "staff.unknownRoles": "Unknown Roles",
      "staff.noProvidersWarning": "No provider detected",
      "staff.noProvidersHint": "No provider (dentist/doctor) detected in staff data – ratios per provider remain 0. Add at least one staff member with role 'dentist', 'zahnarzt', or 'arzt'.",
      "staff.ratioLegend.actual": "Actual:",
      "staff.ratioLegend.target": "Target:",
      "staff.ratioLegend.basis": "Basis:",
      "staff.ratioLegend.basedOn": "With",
      "staff.ratioLegend.actualTotal": "Actual",
      "staff.ratioLegend.targetTotal": "Target",
      "staff.ratioLegend.deltaTotal": "Delta",
      "staff.ratioLegend.units.provider": "Provider",
      "staff.ratioLegend.units.providerFte": "Provider FTE",
      "staff.ratioLegend.units.clinicalAssistant": "Clinical Assist.",
      "staff.ratioLegend.units.clinicalAssistantFte": "Clinical Assist. FTE",
      "staff.ratioLegend.units.frontdesk": "Frontdesk",
      "staff.ratioLegend.units.frontdeskFte": "Frontdesk FTE",
      "staff.ratioLegend.units.supportTotal": "Support total",
      "staff.ratioLegend.units.supportTotalFte": "Support total FTE",
      "staff.ratioLegend.units.examRooms": "Rooms",
      "staff.ratioLegend.units.rooms": "Rooms",
      ...
      "benchmarks.clinicalAssistantRatio": "Clinical Assistants (MFA/ZFA) per Provider",
      "benchmarks.frontdeskRatio": "Frontdesk per Provider",
      "benchmarks.supportTotalRatio": "Total Support Staff per Provider",
      "benchmarks.supportStaffRatio": "Support Staff per Provider",
      "benchmarks.supportStaffDesc": "Recommended: 2 support staff (clinical + frontdesk) per provider for optimal treatment flow. Less staff leads to wait times and stress.",
      "benchmarks.nurseToDoctor": "Clinical Assistants per Provider",
      "benchmarks.nurseToDoctorDesc": "Recommended: 1.5 MFA/ZFA per provider. With prophylaxis focus, ratio may increase to 2:1.",
      "benchmarks.frontdeskRatioDesc": "Recommended: 0.4 receptionists per provider. Ensures smooth patient check-in/out.",
      ...
      "benchmarks.ratioLabels.clinicalAssistantRatio": "Clinical Assistants (MFA/ZFA) per Provider",
      "benchmarks.ratioLabels.frontdeskRatio": "Frontdesk per Provider",
      "benchmarks.ratioLabels.supportTotalRatio": "Total Support (Clinical + Frontdesk) per Provider",
      "benchmarks.ratioLabels.supportStaffRatio": "Total Support (Clinical + Frontdesk) per Provider",
      "benchmarks.ratioLabels.nurseRatio": "Clinical Assistants (MFA/ZFA) per Provider",
      "benchmarks.ratioLabels.examRoomRatio": "Treatment Rooms per Dentist",
      "benchmarks.ratioLabels.clinicalAssistantFteRatio": "Clinical Assistants FTE per Provider FTE",
      "benchmarks.ratioLabels.frontdeskFteRatio": "Frontdesk FTE per Provider FTE",
      "benchmarks.ratioLabels.supportTotalFteRatio": "Total Support FTE per Provider FTE",
  ...
  de: {
    translation: {
      ...
      "staff.currentFte": "Aktuell (VZÄ)",
      "staff.headcount": "Köpfe",
      "staff.optimal": "Optimal",
      "staff.match": "Treffer",
      ...
      "staff.refreshAnalysis": "Neu berechnen",
      "staff.debugInfo": "Debug-Info",
      "staff.roleHistogram": "Rollen-Verteilung",
      "staff.unknownRoles": "Unbekannte Rollen",
      "staff.noProvidersWarning": "Kein Behandler erkannt",
      "staff.noProvidersHint": "Kein Behandler (Zahnarzt/Arzt) in Personal-Daten erkannt – Ratios pro Behandler bleiben 0. Legen Sie mindestens einen Mitarbeiter mit Rolle 'dentist', 'zahnarzt' oder 'arzt' an.",
      "staff.ratioLegend.actual": "Ist:",
      "staff.ratioLegend.target": "Ziel:",
      "staff.ratioLegend.basis": "Basis:",
      "staff.ratioLegend.basedOn": "Bei",
      "staff.ratioLegend.actualTotal": "Ist",
      "staff.ratioLegend.targetTotal": "Ziel",
      "staff.ratioLegend.deltaTotal": "Delta",
      "staff.ratioLegend.units.provider": "Behandler",
      "staff.ratioLegend.units.providerFte": "VZÄ Behandler",
      "staff.ratioLegend.units.clinicalAssistant": "Assistenz (MFA/ZFA)",
      "staff.ratioLegend.units.clinicalAssistantFte": "VZÄ Assistenz",
      "staff.ratioLegend.units.frontdesk": "Empfang",
      "staff.ratioLegend.units.frontdeskFte": "VZÄ Empfang",
      "staff.ratioLegend.units.supportTotal": "Support gesamt",
      "staff.ratioLegend.units.supportTotalFte": "VZÄ Support gesamt",
      "staff.ratioLegend.units.examRooms": "Räume",
      "staff.ratioLegend.units.rooms": "Räume",
      ...
      "benchmarks.clinicalAssistantRatio": "Klinische Assistenz (MFA/ZFA) pro Behandler",
      "benchmarks.frontdeskRatio": "Empfang pro Behandler",
      "benchmarks.supportTotalRatio": "Support gesamt pro Behandler",
      "benchmarks.supportStaffRatio": "Assistenz pro Zahnarzt",
      "benchmarks.supportStaffDesc": "Empfohlen: 2 Mitarbeiter (klinisch + Empfang) pro Behandler für optimale Behandlungsabläufe. Bei weniger Personal entstehen Wartezeiten und Stress.",
      "benchmarks.nurseToDoctor": "MFA/ZFA pro Behandler",
      "benchmarks.nurseToDoctorDesc": "Empfohlen: 1,5 MFA/ZFA pro Behandler. Bei Prophylaxe-Schwerpunkt kann das Verhältnis auf 2:1 steigen.",
      "benchmarks.frontdeskRatioDesc": "Empfohlen: 0,4 Empfangskräfte pro Behandler. Gewährleistet reibungslosen Patienten-Check-in/out.",
      ...
      "benchmarks.ratioLabels.clinicalAssistantRatio": "Klinische Assistenz (MFA/ZFA) pro Behandler",
      "benchmarks.ratioLabels.frontdeskRatio": "Empfang pro Behandler",
      "benchmarks.ratioLabels.supportTotalRatio": "Support gesamt pro Behandler",
      "benchmarks.ratioLabels.supportStaffRatio": "Assistenz pro Zahnarzt",
      "benchmarks.ratioLabels.nurseRatio": "MFA/ZFA pro Behandler",
      "benchmarks.ratioLabels.examRoomRatio": "Behandlungsräume pro Zahnarzt",
      "benchmarks.ratioLabels.clinicalAssistantFteRatio": "Klinische Assistenz VZÄ pro Behandler VZÄ",
      "benchmarks.ratioLabels.frontdeskFteRatio": "Empfang VZÄ pro Behandler VZÄ",
      "benchmarks.ratioLabels.supportTotalFteRatio": "Support VZÄ gesamt pro Behandler VZÄ",
