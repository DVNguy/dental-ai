...
const resources = {
  ...
  de: {
    translation: {
      ...
      "dashboard.aiPracticeHealth": "KI-Praxis-Gesundheit",
      ...
      "dashboard.aiRecommendedImprovements": "KI-empfohlene Verbesserungen",
      ...
      "staff.staffingOptimization": "Personal-Optimierung",
